...
describe "#import" do
  ...
  context "with an array of columns and an array of values" do
    ...
    it "should import data with different encodings" do
      Topic.import [:id, :author_name, :title], [[99, "Bob Jonüs".encode('ISO-8859-1'), "漢"]]
      assert_equal "Bob Jonüs", Topic.last.author_name
      assert_equal "漢", Topic.last.title
    end

    it "should accept encoding as an option" do
      assert_raise(Encoding::UndefinedConversionError) do
        Topic.import [:id, :author_name, :title], [[99, "Bob Jonüs".encode('ISO-8859-1'), "漢"]], :encoding => 'ISO-8859-1'
      end
    end
  end
